...
namespace TinyGiantStudio.Text
{
    ...
    public class Modular3DText : MonoBehaviour
    {
        ...
        /// </summary>
        public bool useIncreasedVerticiesCountForCombinedMesh = true;
        ...
        void CreateSingleMesh()
        {
            ...
            List<Mesh> combinedMeshes = MeshCombiner.CombinedMesh(meshLayouts, GetChildSize(), useIncreasedVerticiesCountForCombinedMesh);
