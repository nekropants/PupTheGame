...
namespace TinyGiantStudio.Text
{
    ...
    public class SliderEditor : Editor
    {
        ...
        void Handle()
        {
            ...
            GUILayout.BeginHorizontal();
            MText_Editor_Methods.PriviewField(unSelectedHandleMat, myTarget.unSelectedHandleMat, "unSelected", variableName + "unSelectedHandleMat");
            MText_Editor_Methods.PriviewField(selectedHandleMat, myTarget.selectedHandleMat, "Selected", variableName + "selectedHandleMat");
            GUILayout.EndHorizontal();

            GUILayout.BeginHorizontal();
            MText_Editor_Methods.PriviewField(clickedHandleMat, myTarget.clickedHandleMat, "Clicked", variableName + "clickedHandleMat");
            MText_Editor_Methods.PriviewField(disabledHandleMat, myTarget.disabledHandleMat, "Disabled", variableName + "disabledHandleMat");
            GUILayout.EndHorizontal();
        }
