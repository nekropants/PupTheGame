    ...
    public class ButtonEditor : Editor
    {
        ...
        void NormalStyle()
        {
            ...
            if (EditorGUILayout.BeginFadeGroup(showNormalItemSettings.faded))
            {
                ...
                GUILayout.BeginHorizontal();
                MText_Editor_Methods.PriviewField(normalTextMaterial, myTarget.NormalTextMaterial, "Text", variableName + "NormalTextMaterial");
                MText_Editor_Methods.PriviewField(normalBackgroundMaterial, myTarget.NormalBackgroundMaterial, "Background", variableName + "NormalBackgroundMaterial");
                GUILayout.EndHorizontal();
            }
        ...
        void SelectedStyle()
        {
            ...
            if (EditorGUILayout.BeginFadeGroup(showSelectedItemSettings.faded))
            {
                ...
                GUILayout.BeginHorizontal();
                MText_Editor_Methods.PriviewField(selectedTextMaterial, myTarget.SelectedTextMaterial, "Text", variableName + "SelectedTextMaterial");
                MText_Editor_Methods.PriviewField(selectedBackgroundMaterial, myTarget.SelectedBackgroundMaterial, "Background", variableName + "SelectedBackgroundMaterial");
                GUILayout.EndHorizontal();
            }
        ...
        void PressedItemSettings()
        {
            ...
            if (EditorGUILayout.BeginFadeGroup(showPressedItemSettings.faded))
            {
                ...
                GUILayout.BeginHorizontal();
                MText_Editor_Methods.PriviewField(pressedTextMaterial, myTarget.PressedTextMaterial, "Text", variableName + "PressedTextMaterial");
                MText_Editor_Methods.PriviewField(pressedBackgroundMaterial, myTarget.PressedBackgroundMaterial, "Background", variableName + "PressedBackgroundMaterial");
                GUILayout.EndHorizontal();
        ...
        void DisabledtStyle()
        {
            ...
            if (EditorGUILayout.BeginFadeGroup(showDisabledItemSettings.faded))
            {
                ...
                GUILayout.BeginHorizontal();
                MText_Editor_Methods.PriviewField(disabledTextMaterial, myTarget.DisabledTextMaterial, "Text", variableName + "DisabledTextMaterial");
                MText_Editor_Methods.PriviewField(disabledBackgroundMaterial, myTarget.DisabledBackgroundMaterial, "Background", variableName + "DisabledBackgroundMaterial");
                GUILayout.EndHorizontal();
            }
            EditorGUILayout.EndFadeGroup();
            GUILayout.EndVertical();
