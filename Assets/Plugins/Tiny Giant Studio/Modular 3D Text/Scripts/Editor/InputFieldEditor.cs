...
namespace TinyGiantStudio.Text
{
    ...
    public class InputFieldEditor : Editor
    {
        ...
        void TextMats()
        {
            ...
            GUILayout.BeginHorizontal();
            MText_Editor_Methods.PriviewField(placeHolderTextMat, myTarget.placeHolderTextMat, "Placeholder Text", variableName + "placeHolderTextMat");
            MText_Editor_Methods.PriviewField(disabledTextMat, myTarget.disabledTextMat, "Disabled Text", variableName + "disabledTextMat");
            GUILayout.EndHorizontal();

            GUILayout.BeginHorizontal();
            MText_Editor_Methods.PriviewField(inFocusTextMat, myTarget.inFocusTextMat, "In Focus Text", variableName + "inFocusTextMat");
            MText_Editor_Methods.PriviewField(outOfFocusTextMat, myTarget.outOfFocusTextMat, "Normal Text", variableName + "outOfFocusTextMat");
            GUILayout.EndHorizontal();
        ...
        void BackgroundMats()
        {
            ...
            GUILayout.BeginHorizontal();
            MText_Editor_Methods.PriviewField(inFocusBackgroundMat, myTarget.inFocusBackgroundMat, "In Focus", variableName + "inFocusBackgroundMat");
            MText_Editor_Methods.PriviewField(outOfFocusBackgroundMat, myTarget.normalBackgroundMaterial, "Normal Focus", variableName + "outOfFocusBackgroundMat");
            GUILayout.EndHorizontal();

            GUILayout.BeginHorizontal();
            MText_Editor_Methods.PriviewField(hoveredBackgroundMat, myTarget.hoveredBackgroundMaterial, "Hovered", variableName + "hoveredBackgroundMat");
            MText_Editor_Methods.PriviewField(disabledBackgroundMat, myTarget.disabledBackgroundMat, "Disabled", variableName + "disabledBackgroundMat");
            GUILayout.EndHorizontal();
