...
public class BinaryTree<T> : ICollection<T>
{
    ...
    /// </summary>
    public BinaryTreeNode<T> Root { get { return _root; } set { _root = value; } }
    /// <summary>
    /// The number of nodes in the entire tree.
    /// </summary>
    public int Count { get { return _root == null ? 0 : _root.CountNodesBelow() + 1; } }
    /// <summary>
    /// The depth of the deepest branch in the tree. 
    /// </summary>
    public int Depth { get { return CalculateDepth(_root); } }
    /// <summary>
...
public class BinaryTreeNode<T>
{
    ...
    /// </summary>
    public bool HasLeftChild { get { return _left != null; } }
    /// <summary>
    /// Whether or not this node has a right child.
    /// </summary>
    public bool HasRightChild { get { return _right != null; } }
    /// <summary>
    /// Whether or not this node has is a leaf node, ie. it has no children.
    /// </summary>
    public bool IsLeaf { get { return _left == null && _right == null; } }
    ...
    /// </summary>
    public BinaryTreeNode<T> LeftChild { get { return _left; } set { _left = value; } }
    /// <summary>
    /// The right child of this node, may be null.
    /// </summary>
    public BinaryTreeNode<T> RightChild { get { return _right; } set { _right = value; } }
