...
public struct FloatModifier
{
    ...
    /// </summary>
    public OperationType Operation { get { return _operation; } set { _operation = value; } }

    /// <summary>
    /// The type of operand to use in the operation.
    /// </summary>
    public OperandType Operand { get { return _operand; } set { _operand = value; } }

    /// <summary>
    /// The operand variation to use.
    /// </summary>
    public VariationType Variation { get { return _variation; } set { _variation = value; } }
