...
public class HexGrid<T> : IEnumerable<T> where T : class
{
    ...
    /// </summary>
    public int Width { get { return _width - 1; } }
    /// <summary>
...
public struct HexCoordinate : IEquatable<HexCoordinate>
{
    ...
    /// </summary>
    public static HexCoordinate SouthWest { get { return new HexCoordinate(0, 1, -1); } }
    /// <summary>
    /// The identity coordinate in the westerly direction.
    /// </summary>
    public static HexCoordinate West { get { return new HexCoordinate(-1, 1, 0); } }
    /// <summary>
    /// The identity coordinate in the north west direction.
    /// </summary>
    public static HexCoordinate NorthWest { get { return new HexCoordinate(-1, 0, 1); } }
    /// <summary>
    /// The identity coordinate in the north east direction.
    /// </summary>
    public static HexCoordinate NorthEast { get { return new HexCoordinate(0, -1, 1); } }
    /// <summary>
    /// The identity coordinate in the easterly direction.
    /// </summary>
    public static HexCoordinate East { get { return new HexCoordinate(1, -1, 0); } }
    /// <summary>
    /// The identity coordinate in the south east direction.
    /// </summary>
    public static HexCoordinate SouthEast { get { return new HexCoordinate(1, 0, -1); } }
    /// <summary>
    /// The origin coordinate.
    /// </summary>
    public static HexCoordinate Zero { get { return new HexCoordinate(0, 0, 0); } }
    ...
    private const float _sizeFactor = 0.5773502691896f;
    ...
    public Vector2 GetCartesian(Vector2 hexDimensions)
    {
        ...
        int row = _z;
        return new Vector2(Mathf.Sqrt(3f) * (float)(column + 0.5 * (row & 1)) * hexDimensions.x, 3f / 2f * row * hexDimensions.y) * _sizeFactor;
    }
    ...
    public static HexCoordinate FromCartesian(Vector2 position, Vector2 hexDimensions)
    {
        ...
        float x = ((position.x / hexDimensions.x) * Mathf.Sqrt(3) / 3 - (position.y / 3 / hexDimensions.y)) / _sizeFactor;
        float z = position.y * 2f / 3f / _sizeFactor / hexDimensions.y;
        float y = -x - z;
