...
public struct Line2
{
    ...
    /// </summary>
    public Vector2 MidPoint { get { return (_end + _start) * 0.5f; } }
    /// <summary>
    /// The normalized direction of the line.
    /// </summary>
    public Vector2 Direction { get { return (_end - _start).normalized; } }
    /// <summary>
    ...
    /// </summary>
    public static Line2 Up { get { return new Line2(Vector2.zero, Vector2.up); } }
    /// <summary>
    /// A line that start at the origin and is aligned with the positive X axis. Has a length of one.
    /// </summary>
    public static Line2 Right { get { return new Line2(Vector2.zero, Vector2.right); } }
