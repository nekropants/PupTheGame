...
public static class VectorExtensions
{
    ...
    {
        int angle = MathUtils.RoundToNearest(Mathf.RoundToInt(Mathf.Rad2Deg * Mathf.Atan2(vector.x, vector.y)), 90);

        switch (angle)
        {
            case 0: return Cardinal4.North;
            case 90: return Cardinal4.East;
            case 180: return Cardinal4.South;
            case -90: return Cardinal4.West;
        }
    ...
    {
        int angle = MathUtils.RoundToNearest(Mathf.RoundToInt(Mathf.Rad2Deg * Mathf.Atan2(vector.x, vector.y)), 45);
        switch (angle)
        {
            case 0: return Cardinal8.North;
            case 45: return Cardinal8.NorthEast;
            case 90: return Cardinal8.East;
            case 135: return Cardinal8.SouthEast;
    ...
    {
        return vector.x >= 0 ? Vector2.Angle(Vector2.up, vector) : 360 - Vector2.Angle(Vector2.up, vector);
    }
    ...
    {
        return vector.x >= 0 ? Vector2.Angle(Vector2.up, vector.ToVector2XZ()) : 360 - Vector2.Angle(Vector2.up, vector.ToVector2XZ());
    }
